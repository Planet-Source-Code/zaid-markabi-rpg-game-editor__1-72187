...
Public MusicFileName(25) As String
...
Sub Initialize_Music(MusNum As Integer)
On Error GoTo MusOut:

Dim i As Integer
For i = 0 To MusNum
    MusicFileName(i) = Format(i) + ".mid"
Next
...
Sub Load_Music(FileNumber As Byte)
    ...
    FileName = App.path & "\Data Game\Music\" & MusicFileName(FileNumber)
